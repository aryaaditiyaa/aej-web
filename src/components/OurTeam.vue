      ...
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-3">
        <div v-for="team in teams" :key="team.id" class="items-center bg-white rounded-lg shadow sm:flex">
          ...
          <div class="p-5">
            ...
            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{{ team[4] }}</p>
...
export default {
  ...
  methods: {
    getTeams() {
      ...
      const SECTION_NAME = 'team-section'

      fetch(`https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values/'${SECTION_NAME}'!A2:F1001?key=${API_KEY}`)
